...
export const metadata: Metadata = buildMetadata({
  title: "Services",
  description: "Explore secure web, design, and cybersecurity consulting services tailored for modern digital products.",
  path: "/services",
  keywords: ["secure web development", "cybersecurity consulting", "ui ux services"],
});

export default function ServicesPage() {
  return (
    <main className="mx-auto min-h-screen max-w-7xl space-y-10 px-4 py-12 sm:px-6 lg:px-10">
      <section className="relative overflow-hidden rounded-3xl border border-cyan-300/25 bg-gradient-to-br from-[#101a30] via-[#0b1220] to-[#0a0f1a] p-8 sm:p-12">
        ...
        <div className="relative z-10 max-w-3xl">
          <p className="text-xs uppercase tracking-[0.24em] text-cyan-200/80">Xybersec Services</p>
      ...
      <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-8 text-center sm:p-10">
        <h2 className="text-2xl font-semibold text-white">Have a project in mind?</h2>
        <p className="mt-3 text-slate-300">Tell us your goals and we&apos;ll shape a secure delivery roadmap.</p>
